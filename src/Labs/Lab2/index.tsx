...
{/* a component that returns the style attribute for Lab 2 */ }
...
export default function Lab2() {
  return (
    <div className="container">
      ...
      wd-bg-color-yellow">
          Padded top left  {/* TO DO: center the text */}
        </div>
      </div>
      ...
      wd-bg-color-blue 
      wd-fg-color-white">
          Margin all around  {/* TO DO: center the text */}
        </div>
      </div>
      <div id="wd-css-borders">
    ...
    wd-fg-color-white">
      ...
      <div id="wd-css-flex">  {/* TO DO: am I supposed to put the code in another .tsx? */}
        <h2>Flex</h2>
      ...
      <div id="wd-css-navigating-with-cards">
        ...
        <div className="card"
          style={{ width: "18rem" }}>
          <img src="images/stacked.jpg"  // Image from https://flic.kr/p/2pQ4ZAT
